...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'description' => esc_html__( 'WPR cards widget.', $this->plugin_slug ), // Update the widget description
		);

		parent::__construct( 'wpr-widget', esc_html__( 'WPR Cards', $this->plugin_slug ), $widget_ops ); // and the widget name
	}
